...
# Further modified to work with chinese text.
...
sub preprocess {
    ...
    # The follow chinese unicode for easy look up
    # U+3002 - 。
    # U+FF1F - ？
    # U+FF01 - ！
    # U+2026 - …
	...
	# Chinese end of sentence makers
	$text =~ s/([?!\x{3002}\x{FF1F}\x{FF01}\x{2026}])/$1\n/g;
	...
	$text =~ s/([?!\x{3002}\x{FF1F}\x{FF01}\x{2026}][\ ]*[\'\"\x{2019}\x{201D}\)\]\x{FF09}\x{3011}\p{IsPf}]+)/$1\n/g;
